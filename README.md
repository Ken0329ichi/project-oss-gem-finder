...
[![GitHub Pages Site](https://img.shields.io/badge/Live%20Demo-GitHub%20Pages-10B981?style=for-the-badge&logo=githubpages&logoColor=white)](https://ken0329ichi.github.io/project-oss-gem-finder/)
...
To ensure a high-quality, relevant, and secure dataset of open-source projects, our automated discovery engine (`src/discovery.py`) scans GitHub using the following strict criteria:
...
### Key Features
- **50,000+ Active Repositories Spectrum**: Comprehensive dataset of active open-source projects (updated within 2 years, MIT / Apache-2.0 licensed).
- **Multi-Dimensional Metrics**: Logarithmic Gem Plotting (Stargazers vs. Forks / PR Velocity / Backlog vs. Good First Issues).
- **Fast Full-Text Search**: Instant filtering powered by Pagefind static search.
- **Cyber-Glow Interactive Charts**: Canvas-powered 60fps scatter plots rendered with Apache ECharts.
